...
STRINGS = {
    ...
    "info_env_example_used": {
        "en": "Found and used the project's own example environment file to pre-fill the variables it references via 'env_file'.",
        "fr": "Le fichier d'exemple d'environnement du projet a été trouvé et utilisé pour pré-remplir les variables qu'il référence via 'env_file'.",
    },
